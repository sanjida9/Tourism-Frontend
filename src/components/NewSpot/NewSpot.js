...
const NewSpot = () => {
    ...
    const onSubmit = data =>{
        axios.post("http://localhost:5001/newSpot", data)
        .then(res => {
    ...
    return (
        <div className="container mx-auto p-4 bg-gray-200 p-4 my-4">
            ...
            <form id="newSpot" className="my-5 p-4" onSubmit={handleSubmit(onSubmit)} >
                <input className="form-control" {...register("planName", { required: true })} placeholder="Plan Name" />
                {errors.planName && <span>This field is required</span>}
                <br /><br />
                <input className="form-control" {...register("location", { required: true })} placeholder="Location" />
                {errors.location && <span>This field is required</span>}
                <br /><br />
                <input className="form-control" {...register("duration", { required: true })} placeholder="Duration" />
                {errors.duration && <span>This field is required</span>}
                <br /><br />
                <input className="form-control" {...register("price", { required: true })} placeholder="Price" />
                {errors.price && <span>This field is required</span>}
                <br /><br />
                <input className="form-control" {...register("rating", { required: true })} placeholder="Rating" />
                {errors.rating && <span>This field is required</span>}
                <br /><br />
                <input className="form-control" {...register("img", { required: true })} placeholder="Image URL" />
